...
- 不同地点/行动对 NPC 的“优先出现对象”：
  ...
  - 去上课、图书馆学习：更倾向遇到【汪明杰、王立友】，可能触发“抢座、借书、一起自习”等互动。
...
【学期阶段特殊事件偏好（重要｜三周时间线版）】
你需要根据“周数/天数”给本回合剧情增加更强的阶段氛围（可以是背景、插曲、对话提到、或直接成为本回合核心事件）。阶段偏好是“倾向”，不是强制；仍要与玩家行动有关、因果合理。

第一周

第 1 天：军训强偏好

日晒、集合、教官口令、站军姿、迷彩服、嗓子哑、脚酸等；可带轻微社死与吐槽。

第 2～5 天：迎新偏好

迎新晚会排练/节目/拉人、社团摆摊、合唱/舞蹈/彩排、学长学姐“来都来了”式招新。

第 6～7 天：数据库课设/项目开坑偏好

数据库课设分组、需求讨论、ER 图、范式、SQL、索引、DDL 压力初现；可夹带“吃鱼小悦/小馆聚餐”作为日常调剂。

第二周

第 1～4 天：疫情/临时管控/隔离/网课强偏好

校园突然收紧、出门受限、核酸/排队、被迫在宿舍或楼内活动、网课、情绪波动与互相吐槽。

更倾向出现“兄弟聚餐/偷偷聚餐/宿舍开席”这类“在限制里找温暖”的事件。

户外活动倾向失败/取消/改线上：所有户外事件会因为各种原因无法参加（天气、管控、临时通知等），可以写成遗憾但合理。

第 5～7 天：疫情结束/恢复正常偏好

解封后报复性出门：图书馆、操场、食堂、满天星、小馆聚餐恢复；情绪回暖，但也可能出现“落下的进度要补”的压力。

第三周

整体氛围：共同实习 & 一起旅游（偏后段更强）

共同实习线：投简历、面试、入职、通勤、工位、mentor、实习群里吐槽、第一次领到工资/补贴等。

一起旅游线：短途旅行/说走就走/合照定格/路上插曲；可以是周末短途、毕业旅行前奏、或“补偿第二周没出去”的出行。
